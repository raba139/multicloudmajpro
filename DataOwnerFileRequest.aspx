<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataOwnerFileRequest.aspx.cs" Inherits="DataOwnerFileRequest" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="DataOwnerFileRequest.aspx" class="active">File Request </a></li>
		...
		<div class="container" align="center">
			...
			<div class="col-md-9 col-sm-9 contact-right">
				<form id="form1" runat="server">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="text-align: center" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15pt" DataSourceID="SqlDataSource1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="RequestDate" HeaderText="RequestDate" SortExpression="RequestDate" />
                             <asp:TemplateField HeaderText="Send Key">
                                         <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HybridSecurityConnectionString %>" SelectCommand="SELECT [RequestID], [UserName], [FileID], [FileName], [RequestDate] FROM [FileRequest] WHERE (([OwnerName] = @OwnerName) AND ([Status] = @Status)) ORDER BY [RequestID] DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextBox5" Name="OwnerName" PropertyName="Text" Type="String" />
                            <asp:Parameter DefaultValue="Owner" Name="Status" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
