...
public partial class CloudAdminDataUserDetails : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("update UserRegister set Request='Accept' where Name='" + name + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();

        Response.Write("<script>alert('Accepted')</script>");
        Response.Redirect("CloudAdminDataUserDetails.aspx");
    }
    ...
    protected void LinkButton2_Click(object sender, EventArgs e)
    {
        ...
        string name = gvrow.Cells[1].Text;
        con.Open();
        cmd = new SqlCommand("update UserRegister set Request='Decline' where Name='" + name + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
