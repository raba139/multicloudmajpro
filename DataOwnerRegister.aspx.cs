...
public partial class DataOwnerRegister : System.Web.UI.Page
{
    ...
    {
        con.Open();
        cmd = new SqlCommand("select * from OwnerRegister where Name='" + TextBox1.Text + "'", con);
        ...
        {
            con1.Open();
            cmd = new SqlCommand("select * from OwnerRegister where MobileNo='" + TextBox4.Text + "'", con1);
            ...
            {
                con2.Open();
                cmd = new SqlCommand("select * from OwnerRegister where MailId='" + TextBox5.Text + "'", con2);
                ...
                {
                    con3.Open();
                    cmd = new SqlCommand("insert into OwnerRegister values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','Pending')", con3);
                    cmd.ExecuteNonQuery();
                    con3.Close();
