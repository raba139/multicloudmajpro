<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CloudAdminLogin.aspx.cs" Inherits="CloudAdminLogin" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="CloudAdminLogin.aspx" class="active">Cloud Admin</a></li>
							</ul>
						</div>
					</nav>
				</div>
...
<div class="contact">
		<div class="container" align="center">
			<h3 class="w3l-titles">Cloud Admin Login</h3>
