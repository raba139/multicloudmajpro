<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataUserFileKey.aspx.cs" Inherits="DataUserFileKey" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="DataUserFileKey.aspx" class="active">File Key</a></li>
...
<div class="contact">
		<div class="container" align="center">
			<h3 class="w3l-titles">File Key</h3>
				...
				<form id="form1" runat="server">
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="text-align: center" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" Font-Size="15pt" DataSourceID="SqlDataSource1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FileKey1" HeaderText="File Key1" SortExpression="FileKey1" />
                            <asp:BoundField DataField="FileKey2" HeaderText="File Key2" SortExpression="FileKey2" />
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HybridSecurityConnectionString %>" SelectCommand="SELECT [FileID], [FileName], [FileKey1], [FileKey2] FROM [SecretKey] WHERE ([UserName] = @UserName)">
                        <SelectParameters>
