<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataOwnerPublicFiles.aspx.cs" Inherits="DataOwnerPublicFiles" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">File Details<span class="caret"></span></a>
...
<div class="contact">
		<div class="container" align="center">
			<h3 class="w3l-titles">Public Files</h3>
			...
			<div class="col-md-9 col-sm-9 contact-right">
				<form id="form1" runat="server">
				    ...
				    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HybridSecurityConnectionString %>" SelectCommand="SELECT [FileName], [UploadFile], [FileID] FROM [Server] WHERE (([Secure] = @Secure) AND ([OwnerName] = @OwnerName)) ORDER BY [FileID] DESC">
                        <SelectParameters>
                            <asp:Parameter DefaultValue="Public" Name="Secure" Type="String" />
                            <asp:ControlParameter ControlID="TextBox5" Name="OwnerName" PropertyName="Text" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </form>
			</div>
