<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataUserPublicFiles.aspx.cs" Inherits="DataUserPublicFiles" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="DataUserPublicFiles.aspx"  class="active">Public Files</a></li>
		...
		<div class="container" align="center">
			...
			<div class="col-md-9 col-sm-9 contact-right">
				<form id="form1" runat="server">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HybridSecurityConnectionString %>" SelectCommand="SELECT [FileID], [FileName], [UploadFile] FROM [Server] WHERE ([Secure] = @Secure) ORDER BY [FileID] DESC">
                        <SelectParameters>
