<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataOwnerRegister.aspx.cs" Inherits="DataOwnerRegister" %>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Data Owner<span class="caret"></span></a>
...
<div class="contact">
		<div class="container" align="center">
			<h3 class="w3l-titles">Data Owner Register</h3>
